...
if __name__ == '__main__':
    ...
    train_idx, test_idx = train_test_split(idx, train_size=0.8, stratify=data.y, random_state=17)
    ...
    data.gt_importance_edges, data.gt_importance_edges_mask = edge_mask_from_node_mask(data.edge_index,
