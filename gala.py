...
class Encoder(nn.Module):
    def __init__(self, input_dim, hidden_dim1=1600, hidden_dim2=400):
        super().__init__()
        self.conv1 = pyg_nn.GCNConv(input_dim, hidden_dim1, cached=True)
        self.conv2 = pyg_nn.GCNConv(hidden_dim1, hidden_dim2, cached=True)
...
class Decoder(nn.Module):
    def __init__(self, input_dim, hidden_dim1=1600, hidden_dim2=400):
        super().__init__()
        self.conv1 = gcn_deconv.GCNDeconv(hidden_dim2, hidden_dim1, improved=True, cached=True)
        self.conv2 = gcn_deconv.GCNDeconv(hidden_dim1, input_dim, improved=True, cached=True)
