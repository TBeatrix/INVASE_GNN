...
def visualize(labels, g):
    ...
    plt.axis('on')
    nx.draw_networkx(g, pos=pos, node_size=5, node_color=labels, edge_color='k',
...
if __name__ == '__main__':
    ...
    # TreeGrid dataset
    dataset = TreeGridDataset( force_reload=True)
    ...
    transform = AddLaplacianEigenvectorPE(8)
    data = transform(data)
